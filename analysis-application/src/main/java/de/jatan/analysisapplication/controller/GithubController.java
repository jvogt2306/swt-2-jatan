...
public class GithubController {
  ...
  @ResponseBody
  public ResponseEntity<List<GithubRepository>> getRepository2() {
    return ResponseEntity.accepted().body(githubService.getRepositories());
  }

  @GetMapping(path = "/user")
  public GithubUser getGithubUser() {
    GithubUser user = githubService.getGithubUser();
