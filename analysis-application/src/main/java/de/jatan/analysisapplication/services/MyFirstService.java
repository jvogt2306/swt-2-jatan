...
import de.jatan.analysisapplication.entities.AppVisitorList;
...
public class MyFirstService {
    ...
    public HelloDto hello(String user) {
        ...
        return new HelloDto(String.format("Hello Jatan Member %s, \n this application has been called %s times. \n Following User visited the page %s", user, counter, visitors));
    }
